  ...
  try {
    ...
    if (!quoted) {
      return sock.sendMessage(chatId, {
        text: "🖼️ *Sticker Maker*\n_Reply to an image or short video with `.sticker`_ to create a cool sticker!",
      });
    }
...
// 📽️ .youtube command - download YouTube video under 30 minutes & 200MB
...
// 🎵 .play command - download audio as MP3
